...
export function getAuthHeaders(): HeadersInit {
  ...
  return {
    ...
    ...(activeUser ? { 'X-Active-User': activeUser } : {}),
  }
}
...
// --- Product categories ---
export async function listProductCategories(type: 'category' | 'subcategory' | 'condition' | 'variant' | 'variant_2'): Promise<string[]> {
...
export async function createProductCategory(type: 'category' | 'subcategory' | 'condition' | 'variant' | 'variant_2', name: string): Promise<void> {
