...
export default function TenantAdmin() {
  ...
  // Tab
  const [activeTab, setActiveTab] = useState<'team' | 'invoicing' | 'accounting' | 'booking' | 'payment-providers' | 'customer-offers' | 'ui-settings' | 'cash' | 'inventory'>('team')
  ...
  >
    {togglingUserId === u.id ? '...' : (u.active ? t('active') : t('inactive'))}
          ...
          return (<>
            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8, alignItems: 'center', marginBottom: 24 }}>
              <select
                ...
                style={{ height: CONTROL_H, flex: '1 1 90px', minWidth: 80, maxWidth: 120, fontSize: 14, borderRadius: 6, border: '1px solid var(--border)', background: 'var(--input, var(--card))', color: 'var(--text)', padding: '0 6px' }}
              >
              ...
              <select
                ...
                style={{ height: CONTROL_H, flex: '2 1 130px', minWidth: 110, fontSize: 14, borderRadius: 6, border: '1px solid var(--border)', background: 'var(--input, var(--card))', color: 'var(--text)', padding: '0 6px' }}
              >
                {[
              ...
              <button
                ...
                disabled={invLoading}
                style={{ height: CONTROL_H, flex: '1 1 auto', padding: '0 16px', whiteSpace: 'nowrap' }}
              >
        ...
        {activeTab === 'inventory' && (
          <>
            <h4 style={{ margin: '0 0 12px' }}>{t('tenantAdmin.inventory.title')}</h4>
