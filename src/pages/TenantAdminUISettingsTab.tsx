              ...
              {pageOverlay.pageId === 'supply-chain' ? (
                ...
                <>
                  ...
                  {pagePreviewTab === 'product' && (() => {
                    ...
                    const showBarcode = pageFieldConfig.barcode !== false
                    ...
                    return (
                      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8, marginBottom: 12 }}>
                        ...
                        <div style={{ position: 'relative', opacity: showBarcode ? 1 : 0.35 }}>
                          ...
                          <div style={{ height: 36, background: 'var(--input-bg, #fff)', border: `1px solid ${showBarcode ? 'var(--color-success, #22c55e)' : 'var(--line)'}`, borderRadius: 6 }} />
                          <button onClick={() => setPageFieldConfig(prev => ({ ...prev, barcode: !showBarcode }))} style={{ position: 'absolute', top: 0, right: 0, height: 20, padding: '0 6px', fontSize: 10, borderRadius: 4 }}>
