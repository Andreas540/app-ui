...
const orderId = hdr[0].id;
    ...
    // SPECIAL CASE: Blanco customers owe Tony $0.50 per item
const BLANCO_CUSTOMER_IDS = [
  'f4bfabe7-62cb-4e08-b98a-b3faed93278f',  // Original Blanco ups
  '9f5b9939-e35f-435f-93aa-0ed5be64b2a1'   // Second Blanco customer
];
