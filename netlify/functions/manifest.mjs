...
export async function handler(event) {
  try {
    ...
    const icon192 = t.app_icon_192 ? `/tenant-icons/${t.app_icon_192}` : '/icons/icon-192.png'
    const icon512 = t.app_icon_512 ? `/tenant-icons/${t.app_icon_512}` : '/icons/icon-512.png'
